...
$dtearsd_post_tag = get_the_tags($pID);

 ?> <div class="post-box-meta d-flex justify-content-between">
	<div class="post-date"><?php the_time( project_dtformat ); ?></div> <?php if($dtearsd_post_tag){ ?> <div
		class="ac-post-cat"> <?php foreach ($dtearsd_post_tag as $category ) { ?> <a
