...
function dawat_editor_css_support() {
	add_theme_support( 'editor-styles' ); // if you don't add this line, your stylesheet won't be added
}

add_action( 'after_setup_theme', 'dawat_editor_css_support' );
...
function dawat_custom_editor_css() {
	wp_enqueue_style(
		'editor-styles-css',
		get_stylesheet_directory_uri() . '/assets/css/admin/dawat-editor-styles.css',
		array( 'wp-edit-blocks' ),
		time()
	);
}

add_action( 'enqueue_block_editor_assets', 'dawat_custom_editor_css' );
