 ...
 */
function dawat_assets() {

	// Enqueue theme styles
	wp_enqueue_style( 'dawat-theme-stylesheet', assetDir . '/css/bundle.min.css?v=' . ASSET_VERSION_CSS, false, null );
	...
	wp_register_script( 'dawat-theme-scripts', assetDir . '/js/bundle.min.js?v=' . ASSET_VERSION_JS, array( 'jquery' ), null, false );
	...
	if ( is_page_template( 'templates/template-team.php' ) ) {
		...
		wp_enqueue_script( 'team-js', get_template_directory_uri() . '/templates/js/team.js', array( 'jquery' ), null, false );
	}
	...
	wp_enqueue_script( 'dawat-theme-scripts' );

}

add_action( 'wp_enqueue_scripts', 'dawat_assets' );
